...
delays = ["0.0", "0.01"]
models = ["resnet18", "resnet32", "resnet50", "resnet110", "vgg16", "vgg16_bn", "minionn"]
# datasets = ["cifar10", "cifar100", "imagenet"]
datasets = ["cifar10", "cifar100"]
config_folder = "configs"
configs = ["default16.yaml", "crypten10.yaml", "florian10.yaml", "honeybadger10.yaml", "crypten8.yaml"]
